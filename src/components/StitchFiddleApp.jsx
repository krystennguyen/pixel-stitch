...
const DEFAULT_PALETTE = [
  '#FFFFFF', '#000000', '#C0392B', '#E67E22', '#F1C40F',
  '#27AE60', '#2980B9', '#8E44AD', '#ECF0F1', '#7F8C8D',
];
const MAX_UNDO = 50;
...
export default function PixelStitchApp() {
  ...
  const handleConvert = useCallback(({ grid: newGrid, palette: newPalette }) => {
    pushUndo(grid);
    setGrid(newGrid);
    ...
    <div className="app-shell">
      ...
      <header className="top-bar">
        ...
        <div className="top-actions">
          <button className="top-action-btn" onClick={handleExportPNG} title="Export PNG">
            Export PNG
          </button>
          <button
